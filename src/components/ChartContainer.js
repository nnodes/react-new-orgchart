...
var _html2canvas = _interopRequireDefault(
  require('html2canvas-render-offscreen')
);
...
var ChartContainer = (0, _react.forwardRef)(function (_ref, ref) {
  ...
  var exportPDF = function exportPDF(canvas, exportFilename) {
    var canvasWidth = Math.floor(8000);
    var canvasHeight = Math.floor(8000);
    var doc =
  ...
  return _react.default.createElement(
    ...
    _react.default.createElement(
      ...
      _react.default.createElement(
        'ul',
        null,
        _react.default.createElement(_ChartNode.default, {
